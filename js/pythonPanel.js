var pythonPanel = new function() {
  ...
  this.loadPythonFromBlockly = function() {
    ...
    // Set appropriate file extension and mode based on generator type
    if (blockly.generatorType == 'arduino') {
      filesManager.select('main.ino');
      self.editor.session.setMode('ace/mode/c_cpp');
    } else {
    ...
    console.log('Generated code (type=' + blockly.generatorType + '):', code);
