ROVER Sim
===
Robot Operations Virtual Environment and Research Simulator

This simulator was created to allow anyone to experiment with robotics and Arduino programming without owning a physical robot.

Built on the Gears platform with Arduino C++ code generation support.
