...
`), d = b.valueToCode(a, "RED", Order$$module$build$src$generators$python$python_generator.NONE) || 0, e = b.valueToCode(a, "GREEN", Order$$module$build$src$generators$python$python_generator.NONE) || 0;
...
def ${b.FUNCTION_NAME_PLACEHOLDER_}(colour1, colour2, ratio):
  ...
  return '#%02x%02x%02x' % (r, g, b)
`
        ), d = b.valueToCode(a, "COLOUR1", Order$$module$build$src$generators$python$python_generator.NONE) || "'#000000'", e = b.valueToCode(a, "COLOUR2", Order$$module$build$src$generators$python$python_generator.NONE) || "'#000000'";
        ...
        return [
          "[]",
          Order$$module$build$src$generators$python$python_generator.ATOMIC
        ];
        ...
        for (let d = 0; d < a.itemCount_; d++)
          c[d] = b.valueToCode(a, "ADD" + d, Order$$module$build$src$generators$python$python_generator.NONE) || "None";
        ...
        const c = b.valueToCode(a, "FIND", Order$$module$build$src$generators$python$python_generator.NONE) || "[]", d = b.valueToCode(a, "VALUE", Order$$module$build$src$generators$python$python_generator.NONE) || "''";
        let e = " -1", f = "", g = " - 1";
...
`)) + "(" + d + ", " + c + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
        ...
        switch (d) {
          case "FIRST":
            if ("GET" === c)
              return [e + "[0]", Order$$module$build$src$generators$python$python_generator.MEMBER];
            if ("GET_REMOVE" === c)
              return [e + ".pop(0)", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
            if ("REMOVE" === c)
              return e + ".pop(0)\n";
            break;
          case "LAST":
            if ("GET" === c)
              return [e + "[-1]", Order$$module$build$src$generators$python$python_generator.MEMBER];
            if ("GET_REMOVE" === c)
              return [e + ".pop()", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
            if ("REMOVE" === c)
              return e + ".pop()\n";
            break;
          case "FROM_START":
            ...
            if ("GET" === c)
              return [e + "[" + a + "]", Order$$module$build$src$generators$python$python_generator.MEMBER];
            if ("GET_REMOVE" === c)
              return [e + ".pop(" + a + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
            if ("REMOVE" === c)
              return e + ".pop(" + a + ")\n";
            break;
          case "FROM_END":
            a = b.getAdjustedInt(a, "AT", 1, true);
            if ("GET" === c)
              return [e + "[" + a + "]", Order$$module$build$src$generators$python$python_generator.MEMBER];
            if ("GET_REMOVE" === c)
              return [e + ".pop(" + a + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
          ...
          case "RANDOM":
            b.definitions_.import_random = "import random";
            if ("GET" === c)
              return ["random.choice(" + e + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
...
`) + "(" + e + ")";
            if ("GET_REMOVE" === c)
              return [e, Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
            if ("REMOVE" === c)
              return e + "\n";
        }
        ...
        switch (e) {
          ...
          case "FROM_START":
            ...
            break;
          case "FROM_END":
            b = b.getAdjustedInt(a, "AT", 1, true);
            if ("SET" === d)
              return c + "[" + b + "] = " + f + "\n";
            if ("INSERT" === d)
              return c + ".insert(" + b + ", " + f + ")\n";
        ...
        switch (d) {
          case "FROM_START":
            ...
            break;
          case "FROM_END":
            d = b.getAdjustedInt(a, "AT1", 1, true);
            break;
          case "FIRST":
            d = "";
            break;
        ...
        const c = b.valueToCode(a, "LIST", Order$$module$build$src$generators$python$python_generator.NONE) || "[]", d = a.getFieldValue("TYPE");
...
`) + "(" + c + ', "' + d + '", ' + a + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
        ...
        if ("SPLIT" === c)
          c = b.valueToCode(a, "INPUT", Order$$module$build$src$generators$python$python_generator.MEMBER) || "''", a = b.valueToCode(a, "DELIM", Order$$module$build$src$generators$python$python_generator.NONE), a = c + ".split(" + a + ")";
        else if ("JOIN" === c)
          c = b.valueToCode(a, "INPUT", Order$$module$build$src$generators$python$python_generator.NONE) || "[]", a = (b.valueToCode(a, "DELIM", Order$$module$build$src$generators$python$python_generator.MEMBER) || "''") + ".join(" + c + ")";
        else
        ...
        do
          f = b.valueToCode(a, "IF" + c, Order$$module$build$src$generators$python$python_generator.NONE) || "False", e = b.statementToCode(a, "DO" + c) || b.PASS, b.STATEMENT_SUFFIX && (e = b.prefixLines(b.injectId(b.STATEMENT_SUFFIX, a), b.INDENT) + e), d += (0 === c ? "if " : "elif ") + f + ":\n" + e, c++;
        while (a.getInput("IF" + c));
        if (a.getInput("ELSE") || b.STATEMENT_SUFFIX)
          e = b.statementToCode(a, "ELSE") || b.PASS, b.STATEMENT_SUFFIX && (e = b.prefixLines(b.injectId(b.STATEMENT_SUFFIX, a), b.INDENT) + e), d += "else:\n" + e;
        return d;
      }, logic_compare$$module$build$src$generators$python$logic = function(a, b) {
        const c = { EQ: "==", NEQ: "!=", LT: "<", LTE: "<=", GT: ">", GTE: ">=" }[a.getFieldValue("OP")], d = Order$$module$build$src$generators$python$python_generator.RELATIONAL, e = b.valueToCode(a, "A", d) || "0";
        a = b.valueToCode(a, "B", d) || "0";
        return [e + " " + c + " " + a, d];
      }, logic_operation$$module$build$src$generators$python$logic = function(a, b) {
        const c = "AND" === a.getFieldValue("OP") ? "and" : "or", d = "and" === c ? Order$$module$build$src$generators$python$python_generator.LOGICAL_AND : Order$$module$build$src$generators$python$python_generator.LOGICAL_OR;
        ...
        const c = b.valueToCode(a, "IF", Order$$module$build$src$generators$python$python_generator.CONDITIONAL) || "False", d = b.valueToCode(a, "THEN", Order$$module$build$src$generators$python$python_generator.CONDITIONAL) || "None";
        ...
        let d = b.valueToCode(a, "BOOL", c ? Order$$module$build$src$generators$python$python_generator.LOGICAL_NOT : Order$$module$build$src$generators$python$python_generator.NONE) || "False", e = b.statementToCode(a, "DO");
        ...
        var d = b.valueToCode(a, "FROM", Order$$module$build$src$generators$python$python_generator.NONE) || "0", e = b.valueToCode(
          a,
          "TO",
          Order$$module$build$src$generators$python$python_generator.NONE
        ) || "0", f = b.valueToCode(a, "BY", Order$$module$build$src$generators$python$python_generator.NONE) || "1";
...
`);
        ...
        if ($.isNumber$$module$build$src$core$utils$string(d) && $.isNumber$$module$build$src$core$utils$string(e) && $.isNumber$$module$build$src$core$utils$string(f))
          d = Number(d), e = Number(e), f = Math.abs(Number(f)), 0 === d % 1 && 0 === e % 1 && 0 === f % 1 ? (d <= e ? (e++, a = 0 === d && 1 === f ? e : d + ", " + e, 1 !== f && (a += ", " + f)) : (e--, a = d + ", " + e + ", -" + f), a = "range(" + a + ")") : (a = d < e ? a() : k(), a += "(" + d + ", " + e + ", " + f + ")");
        else {
        ...
        const c = b.getVariableName(a.getFieldValue("VAR")), d = b.valueToCode(a, "LIST", Order$$module$build$src$generators$python$python_generator.RELATIONAL) || "[]";
        ...
        var c = { ADD: [" + ", Order$$module$build$src$generators$python$python_generator.ADDITIVE], MINUS: [" - ", Order$$module$build$src$generators$python$python_generator.ADDITIVE], MULTIPLY: [" * ", Order$$module$build$src$generators$python$python_generator.MULTIPLICATIVE], DIVIDE: [" / ", Order$$module$build$src$generators$python$python_generator.MULTIPLICATIVE], POWER: [" ** ", Order$$module$build$src$generators$python$python_generator.EXPONENTIATION] }[a.getFieldValue("OP")];
        const d = c[0];
        c = c[1];
        ...
        let d;
        if ("NEG" === c)
          return d = b.valueToCode(a, "NUM", Order$$module$build$src$generators$python$python_generator.UNARY_SIGN) || "0", ["-" + d, Order$$module$build$src$generators$python$python_generator.UNARY_SIGN];
        b.definitions_.import_math = "import math";
        a = "SIN" === c || "COS" === c || "TAN" === c ? b.valueToCode(
          a,
          "NUM",
          Order$$module$build$src$generators$python$python_generator.MULTIPLICATIVE
        ) || "0" : b.valueToCode(a, "NUM", Order$$module$build$src$generators$python$python_generator.NONE) || "0";
        switch (c) {
          case "ABS":
            d = "math.fabs(" + a + ")";
            break;
        ...
        if (d)
          return [d, Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
        switch (c) {
          case "ASIN":
        ...
        var c = {
          ...
          NEGATIVE: [
            " < 0",
            Order$$module$build$src$generators$python$python_generator.RELATIONAL,
            Order$$module$build$src$generators$python$python_generator.RELATIONAL
          ],
        ...
        if ("PRIME" === d)
          b.definitions_.import_math = "import math", b.definitions_.from_numbers_import_Number = "from numbers import Number", a = b.provideFunction_("math_isPrime", `
...
`) + "(" + a + ")";
        ...
        const c = b.valueToCode(a, "VALUE", Order$$module$build$src$generators$python$python_generator.NONE) || "0", d = b.valueToCode(a, "LOW", Order$$module$build$src$generators$python$python_generator.NONE) || "0";
        ...
        var c = [], d = a.workspace, e = $.allUsedVarModels$$module$build$src$core$variables(d) || [];
        for (var f of e)
          e = f.name, -1 === a.getVars().indexOf(e) && c.push(b.getVariableName(e));
        d = $.allDeveloperVariables$$module$build$src$core$variables(d);
        for (f = 0; f < d.length; f++)
          c.push(b.nameDB_.getName(d[f], $.NameType$$module$build$src$core$names.DEVELOPER_VARIABLE));
        ...
        let g = b.statementToCode(a, "STACK"), h = b.valueToCode(a, "RETURN", Order$$module$build$src$generators$python$python_generator.NONE) || "", k = "";
        g && h && (k = f);
        h ? h = b.INDENT + "return " + h + "\n" : g || (g = b.PASS);
        const l = [], m = a.getVars();
        for (let n = 0; n < m.length; n++)
          l[n] = b.getVariableName(m[n]);
        d = "def " + c + "(" + l.join(", ") + "):\n" + d + f + e + g + k + h;
        d = b.scrub_(a, d);
        b.definitions_["%" + c] = d;
        return null;
        ...
        for (let f = 0; f < e.length; f++)
          d[f] = b.valueToCode(a, "ARG" + f, Order$$module$build$src$generators$python$python_generator.NONE) || "None";
        ...
        b.STATEMENT_SUFFIX && (c += b.prefixLines(b.injectId(
          b.STATEMENT_SUFFIX,
          a
        ), b.INDENT));
        ...
        switch (a.itemCount_) {
          ...
          default:
            c = [];
            for (let d = 0; d < a.itemCount_; d++)
              c[d] = b.valueToCode(a, "ADD" + d, Order$$module$build$src$generators$python$python_generator.NONE) || "''";
        ...
        const c = "FIRST" === a.getFieldValue("END") ? "find" : "rfind", d = b.valueToCode(a, "FIND", Order$$module$build$src$generators$python$python_generator.NONE) || "''";
        ...
        const c = a.getFieldValue("WHERE") || "FROM_START", d = b.valueToCode(a, "VALUE", "RANDOM" === c ? Order$$module$build$src$generators$python$python_generator.NONE : Order$$module$build$src$generators$python$python_generator.MEMBER) || "''";
        switch (c) {
          case "FIRST":
          ...
          case "FROM_END":
            return a = b.getAdjustedInt(a, "AT", 1, true), [d + "[" + a + "]", Order$$module$build$src$generators$python$python_generator.MEMBER];
          case "RANDOM":
...
`) + "(" + d + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
        ...
        const d = a.getFieldValue("WHERE2"), e = b.valueToCode(a, "STRING", Order$$module$build$src$generators$python$python_generator.MEMBER) || "''";
        switch (c) {
          case "FROM_START":
            ...
            break;
          case "FROM_END":
            c = b.getAdjustedInt(a, "AT1", 1, true);
            break;
          case "FIRST":
            c = "";
            break;
        ...
        switch (d) {
          case "FROM_START":
            ...
            break;
          case "FROM_END":
            a = b.getAdjustedInt(a, "AT2", 0, true);
            $.isNumber$$module$build$src$core$utils$string(String(a)) ? 0 === a && (a = "") : (b.definitions_.import_sys = "import sys", a += " or sys.maxsize");
            break;
          case "LAST":
            a = "";
        ...
        const c = { UPPERCASE: ".upper()", LOWERCASE: ".lower()", TITLECASE: ".title()" }[a.getFieldValue("CASE")];
        ...
        const c = { LEFT: ".lstrip()", RIGHT: ".rstrip()", BOTH: ".strip()" }[a.getFieldValue("MODE")];
        return [(b.valueToCode(a, "TEXT", Order$$module$build$src$generators$python$python_generator.MEMBER) || "''") + c, Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
...
`);
        ...
        const c = b.valueToCode(a, "TEXT", Order$$module$build$src$generators$python$python_generator.MEMBER) || "''", d = b.valueToCode(a, "FROM", Order$$module$build$src$generators$python$python_generator.NONE) || "''";
        a = b.valueToCode(a, "TO", Order$$module$build$src$generators$python$python_generator.NONE) || "''";
        return [
          c + ".replace(" + d + ", " + a + ")",
          Order$$module$build$src$generators$python$python_generator.MEMBER
        ];
      ...
      var PythonGenerator$$module$build$src$generators$python$python_generator = class extends $.CodeGenerator$$module$build$src$core$generator {
        constructor(a = "Python") {
          super(a);
          this.ORDER_OVERRIDES = [[Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL, Order$$module$build$src$generators$python$python_generator.MEMBER], [Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL, Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL], [
            Order$$module$build$src$generators$python$python_generator.MEMBER,
            Order$$module$build$src$generators$python$python_generator.MEMBER
          ], [Order$$module$build$src$generators$python$python_generator.MEMBER, Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL], [Order$$module$build$src$generators$python$python_generator.LOGICAL_NOT, Order$$module$build$src$generators$python$python_generator.LOGICAL_NOT], [Order$$module$build$src$generators$python$python_generator.LOGICAL_AND, Order$$module$build$src$generators$python$python_generator.LOGICAL_AND], [
            Order$$module$build$src$generators$python$python_generator.LOGICAL_OR,
            Order$$module$build$src$generators$python$python_generator.LOGICAL_OR
          ]];
          this.PASS = "";
          this.isInitialized = false;
          for (const b in Order$$module$build$src$generators$python$python_generator)
            a = Order$$module$build$src$generators$python$python_generator[b], "string" !== typeof a && (this["ORDER_" + b] = a);
        ...
        init(a) {
          ...
          for (let d = 0; d < c.length; d++)
            b.push(this.nameDB_.getName(c[d], $.Names$$module$build$src$core$names.DEVELOPER_VARIABLE_TYPE) + " = None");
          a = $.allUsedVarModels$$module$build$src$core$variables(a);
          for (c = 0; c < a.length; c++)
            b.push(this.getVariableName(a[c].getId()) + " = None");
        ...
        getAdjustedInt(a, b, c = 0, d = false) {
      ...
      var controls_ifelse$$module$build$src$generators$python$logic = controls_if$$module$build$src$generators$python$logic, module$build$src$generators$python$logic = {};
      ...
      var controls_repeat$$module$build$src$generators$python$loops = controls_repeat_ext$$module$build$src$generators$python$loops, module$build$src$generators$python$loops = {};
      ...
      var math_round$$module$build$src$generators$python$math = math_single$$module$build$src$generators$python$math, math_trig$$module$build$src$generators$python$math = math_single$$module$build$src$generators$python$math, module$build$src$generators$python$math = {};
      ...
      var procedures_defnoreturn$$module$build$src$generators$python$procedures = procedures_defreturn$$module$build$src$generators$python$procedures, module$build$src$generators$python$procedures = {};
      ...
      var strRegExp$$module$build$src$generators$python$text = /^\s*'([^']|\\')*'\s*$/, forceString$$module$build$src$generators$python$text = function(a) {
      ...
      }, text_prompt$$module$build$src$generators$python$text = text_prompt_ext$$module$build$src$generators$python$text, module$build$src$generators$python$text = {};
      ...
      for (const a in generators$$module$build$src$generators$python)
        pythonGenerator$$module$build$src$generators$python.forBlock[a] = generators$$module$build$src$generators$python[a];
...
var require_python = __commonJS({
  "node_modules/blockly/python.js"(exports, module) {
    ...
    })(exports, function(Blockly, BlocklyPython) {
...
blockly/python.js:
   ...
   *)
*/
//# sourceMappingURL=blockly_python.js.map
