...
var require_mode_c_cpp = __commonJS({
  "node_modules/ace-builds/src-noconflict/mode-c_cpp.js"(exports, module) {
    ...
    ace.define("ace/mode/c_cpp_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.c_cppHighlightRules = c_cppHighlightRules;
    });
    ...
    ace.define("ace/mode/c_cpp", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/c_cpp_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var c_cppHighlightRules = require2("./c_cpp_highlight_rules").c_cppHighlightRules;
...
export default require_mode_c_cpp();
//# sourceMappingURL=ace-builds_src-noconflict_mode-c_cpp.js.map
